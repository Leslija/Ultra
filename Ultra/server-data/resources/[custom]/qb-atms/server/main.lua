...
CreateThread(function()
    while true do
        Wait(3600000)
        dailyWithdraws = {}
        TriggerClientEvent('QBCore:Notify', -1, "Limite diário resetado.", "success")
    end
end)
        ...
        if dailyWith < Config.DailyLimit then
            ...
            if xCH ~= nil then
                ...
                if bankCount > 0 then
                    ...
                    TriggerClientEvent('QBCore:Notify', src, "Levantamento de " .. data.amount .. '€ do cartão de crédito. Levantamentos diário: ' .. dailyWithdraws[cardHolder], "success")
                else
            ...
            TriggerClientEvent('QBCore:Notify', src, "Chegas-te ao limite diário", "error")
        end
    end
end)
