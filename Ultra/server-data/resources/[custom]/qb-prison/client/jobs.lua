...
function CreateJobBlip(noItem) -- Used globally
    ...
    AddTextComponentSubstringPlayerName("Trabalho Prisão")
...
local function StartWork()
    ...
    QBCore.Functions.Progressbar("work_electric", "A trabalhar..", math.random(5000, 10000), false, true, {
    ...
    for k in pairs(Config.Locations.jobs) do
        for i = 1, #Config.Locations.jobs[k] do
            ...
            if Config.UseTarget then
                exports['s_target']:AddBoxZone("work_"..k.."_"..i, current.coords.xyz, 1.5, 1.6, {
                    name = "work_"..k.."_"..i,
                    heading = 12.0,
                    debugPoly = false,
                    minZ = 19,
