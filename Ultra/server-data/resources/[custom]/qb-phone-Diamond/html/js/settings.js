QB.Phone.Settings = {};
QB.Phone.Settings.Background = "default-ultra";
QB.Phone.Settings.OpenedTab = null;
QB.Phone.Settings.Backgrounds = {
    'default-ultra': {
        label: "Default Diamond"
    }
};
...
$(document).on('click', '#accept-background', function(e){
    ...
    if (hasCustomBackground === false) {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "Definições", QB.Phone.Settings.Backgrounds[QB.Phone.Settings.Background].label+" foi aplicado!")
        ...
        QB.Phone.Notifications.Add("fas fa-paint-brush", "Definições", "Background aplicado!")
        QB.Phone.Animations.TopSlideUp(".settings-"+QB.Phone.Settings.OpenedTab+"-tab", 200, -100);
...
$(document).on('click', '#accept-profilepicture', function(e){
    ...
    if (ProfilePicture === "default") {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "Definições", "Foto default selecionada!")
        QB.Phone.Animations.TopSlideUp(".settings-"+QB.Phone.Settings.OpenedTab+"-tab", 200, -100);
        $("[data-settingstab='profilepicture']").find('.settings-tab-icon').html('<img src="./img/default.png">');
    } else {
        QB.Phone.Notifications.Add("fas fa-paint-brush", "Definições", "Foto pessoal selecionada!")
        QB.Phone.Animations.TopSlideUp(".settings-"+QB.Phone.Settings.OpenedTab+"-tab", 200, -100);
