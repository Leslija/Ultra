...
$(document).on('click', '#tweet-button', function(e){
    ...
    if (TweetMessage != "") {
        ...
        QB.Phone.Notifications.Add("fab fa-twitter", "Twitter", "Fill a message!", "#00b6c3");
    };
    $('#tweet-new-url').val("");
...
$(document).on('click', '#advert-button', function(e){
    ...
    if (Advert !== "") {
        ...
        QB.Phone.Notifications.Add("fas fa-ad", "Mercado", "Não podes colocar um anúncio vazio!", "#00f8b9", 2000);
    }
});
