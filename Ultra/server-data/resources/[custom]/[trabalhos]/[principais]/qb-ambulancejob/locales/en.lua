local Translations = {
    ...
    info = {
        ...
        respawn_revive = 'PRESSIONA [~r~E~s~] DURANTE %{holdtime} SEGUNDOS PARA RENASCERES POR ~r~%{cost}~s~€',
        ...
        help_requested = 'OS SERVIÇOS DE INEM FORAM NOTIFICADOS',
    ...
    text = {
        ...
        armory_button = '[E] - Armário',
        armory = 'Armário',
        storeveh_button = '[E] - Guardar veículo',
        veh_button = '[E] - Veículos',
        storeheli_button = '[E] - Guardar helicoptero',
        heli_button = '[E] - Tirar helicoptero',
