Config = {}
Config.UseTarget = false -- Use s_target interactions (don't change this, go to your server.cfg and add setr UseTarget true)
...
Config.Helicopter = "heli1inem" -- Helicopter model that players with the ambulance job can use
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["duty"] = {
        [1] = vector3(311.06, -593.92, 43.28), 
    },
    ["vehicle"] = {
        [1] = vector4(292.56, -607.85, 43.35, 69.99),
    },
    ["helicopter"] = {
        [1] = vector4(350.94, -588.3, 74.17, 338.98), 
    },
    ["armory"] = {
        [1] = vector3(311.78, -597.48, 43.28),
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(332.37, -595.77, 43.28),
    },
    ["stash"] = {
        [1] = vector3(306.62, -601.76, 43.28), 
    },
    ["beds"] = {
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
	-- Grade 0
	[0] = {
        ["ambulancei"] = "Volkswagen Carrinha",
        ["anpc_l200"] = "Mitsubishi INEM",
        ["pt_inem4"] = "Ambulância",
	},
	-- Grade 1
	[1] = {
