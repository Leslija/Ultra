...
var quotes = [
  'Nem todos são nosso inimigos , mas também não são aliados!',
  'Alguem lé mesmo isto?',
]
...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    let licencesHTML = '<div style="color: #fff; text-align:center;">Sem Licensas</div>';
    let tagsHTML = '<div style="color: #fff; text-align:center;">Sem Tags</div>';
    let convHTML = '<div style="color: #fff; text-align:center;">Sem Condenações</div>';
    let vehHTML = '<div style="color: #fff; text-align:center;">Sem Veiculos</div>';
    let galleryHTML = '<div style="color: #fff; text-align:center;">Sem Fotos</div>';
      ...
      if (canSaveProfile == true) {
        ...
        setTimeout(() => {
          if (canRefreshIncidents == true) {
            ...
            setTimeout(() => {
              $(".incidents-search-refresh").empty();
              $(".incidents-search-refresh").html("Actualizar");
  ...
  $(".manage-bolos-title-holder").on(
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.png") {
        template =
          "ICU #: [ # ]\n\n ID Relatorio : [ ID do relatorio ]\n\n Hora de Admissão: [ Data e Hora ]\n\n Cirurgia?: [Sim/Não]\n\n Ferimentos:\n - [ Lista de Ferimentos ]\n\n\n Atendimentos extra:\n - [ Lista de enferimeiros e outros Trabalhadores ]\n\n\n🧑‍🤝‍🧑 Contato emergencia adicional:\n - [ Nome e numero ]\n\n\n Notas:\n[Notas adicionais]";
      }
      $(".manage-bolos-editing-title").html(
        "Estas a criar um novo mandato"
      );
  ...
  $(".bolos-search-refresh").click(function () {
    if (canRefreshBolo == true) {
      ...
      setTimeout(() => {
        $(".bolos-search-refresh").empty();
        $(".bolos-search-refresh").html("Actualizar");
        canRefreshBolo = true;
    ...
    function () {
      ...
      $(".incidents-ghost-holder").prepend(
        `
          ...
          "cid"
        )}"><img src="https://i.imgur.com/h7S5f9J.png"> <input placeholder="Multa..." value="0" class="fine-amount" data-id="${$(
          this
        ).data("cid")}" type="number"></div>
                <div class="manage-incidents-title-tag" data-id="${$(this).data(
          "cid"
          ...
          "cid"
        )}"><img src="https://i.imgur.com/9Xn6xXK.png"> <input placeholder="Meses..." value="0" class="sentence-amount" data-id="${$(
          this
        ).data("cid")}" type="number"></div>
            </div>
            `
  ...
  $(".reports-search-refresh").click(function () {
    if (canRefreshReports == true) {
      ...
      setTimeout(() => {
        $(".reports-search-refresh").empty();
        $(".reports-search-refresh").html("Actualizar");
  ...
  $(".dispatch-comms-refresh").click(function () {
    ...
    setTimeout(() => {
      $(".dispatch-comms-refresh").empty();
      $(".dispatch-comms-refresh").html("Actualizar");
      canRefreshReports = true;
  ...
  $(".manage-reports-title-holder").on(
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.png") {
        template =
          "Entras-te emergencias?: [Sim/Nã o]\n\nRelatorio Incidente:\n[ Resumo rapido do que aconteceu no local. ]\n\n\n Lista de feirmentos:\n- [ Estados dos ferimentos ]\n\n\n💉 Relatorio cirurgico:\n[ Relatorio completo do cirurgião ]\n\n\n Enfermeiros:\n- [ Lista de enfermeiros ]\n\n\nMedicamentos aplicados :\n- [ Lista de Medicamentos ]\n\n\nNotas:\n[ Notas adicionais ]";
      }
      $(".manage-reports-editing-title").html(
        "Estas a criar um novo relatorio"
      );
            ...
            `
                            <div class="profile-item" data-id="0">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <div class="profile-item-title">Sem correspondencias</div>
                                    </div>
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <div class="dmv-item-title">${value.model}</div>
                                    <div class="dmv-tags">
                                        ...
                                        <div class="dmv-tag ${bolo}">Mandato</div>
                                        <div class="dmv-tag ${stolen}">Roubado</div>
                                        <div class="dmv-tag ${codefive}">Codigo 5</div>
                                    </div>
                                </div>
                                <div class="dmv-bottom-info">
                                    <div class="dmv-id">Matricula: ${value.plate} · Dono: ${value.owner}</div>
                                </div>
                            </div>
                        </div>
                    `;
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined) {
        ...
        $(".header-title").html("DEPARTAMENTO POLICIA LOS SANTOS");
        $(".bolo-nav-item").html("Mandatos");
        $(".bolos-search-title").html("Mandato");
        $("#bolos-search-input").attr("placeholder", "Procuar mandato...");
        $(".manage-bolos-title").html("Org. Mandato");
        $(".manage-bolos-editing-title").html(
          "Estas a criar um mandato"
        );
        ...
        $("#boloplate").attr("placeholder", "Matricula...");
        $("#bolodetail").attr(
          "placeholder",
          "Detalhes mandato..."
        );
        ...
        $(".header-title").html("Hospital PILLBOX");
        $(".bolo-nav-item").html("ICU");
        $(".bolos-search-title").html("Check-ins");
        $("#bolos-search-input").attr(
          "placeholder",
          "Procurar Check-in..."
        );
        $(".manage-bolos-title").html("Org. Check-in");
        $(".manage-bolos-editing-title").html(
          "A criar um novo Check-In"
        );
        ...
        $(".dmv-nav-item").hide();
        $(".cams-nav-item").hide();
        $("#reports-officers-involved-tag-title").html("INEM Involvido");
        $(".dispatch-title-ofsomesort").html("Dispatch");
        $(".dispatch-comms-container").fadeIn(0);
        $(".manage-profile-name-input-1").attr("readonly", true);
        $(".manage-profile-name-input-2").attr("readonly", true);
        ...
        $(".header-title").html("DEPARTAMENTO DE JUSTIÇA");
        $(".bolo-nav-item").hide();
        $(".dispatch-title-ofsomesort").html("Messagem");
    ...
    if (eventData.type == "show") {
      ...
      activeUnits.forEach((unit) => {
        ...
        if (PoliceJobs[unit.unitType] !== undefined) {
          policeCount++;
          activeInfoJob = `<div class="unit-job active-info-job-lspd">POLICIA</div>`;
        } else if (AmbulanceJobs[unit.unitType] !== undefined) {
          activeInfoJob = `<div class="unit-job active-info-job-ambulance">INEM</div>`
          emsCount++;
      ...
      if (value && value.job.includes(playerJob)) {
        ...
        if (value["automaticGunfire"] == true) {
          DispatchItem += `<div class="call-bottom-info"><span class="fab fa-blackberry"></span>Arma automatica</div>`;
        }
      ...
      if ($(".respond-calls-container").data("id") == eventData.callid) {
        $(".respond-calls-responses").prepend(
          ...
          } respondeu "${eventData["message"]}" - ${timeAgo(
      ...
      $.each(table, function (index, value) {
        $(".respond-calls-responses").prepend(
          ...
          } respondeu "${value["message"]}" - ${timeAgo(
            Number(value.time)
          )}. </div>`
        );
      });
        ...
        $(".incidents-items").append(
          `<div class="incidents-item" data-id="${value.id}">
                    <div class="incidents-top-holder">
                        ...
                        <div class="incedent-report-name">Relatorio</div>
                    </div>
      ...
      if (PoliceJobs[playerJob] !== undefined || AmbulanceJobs[playerJob] !== undefined) {
        $(".manage-incidents-title-holder").prepend(
          `
            <div class="manage-incidents-title">Org. Incidentes</div>
            <div class="manage-incidents-create"> <span class="fas fa-plus" style="margin-top: 3.5px;"></span></div>
            <div class="manage-incidents-save"><span class="fas fa-save" style="margin-top: 3.5px;"></span></div>
            `
        );
        ...
        if (value.associated == 1) {
          $(".incidents-ghost-holder").prepend(
            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                            ...
                            <div class="associated-incidents-user-tags-holder">
                                <div class="associated-incidents-user-tag ${warrantTag}" data-id="${value.cid}">Relatorio</div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}" style="display:none;">Senteça recomendada</div>
                            ...
                            <div class="associated-incidents-fine-input" data-id="${value.cid}" style="display:none;"><img src="https://i.imgur.com/h7S5f9J.png"> <input placeholder="Multa..." value="0" class="fine-amount" data-id="${value.cid}" type="number"></div>
                            <div class="manage-incidents-title-tag" data-id="${value.cid}" style="display:none;">Sentença</div>
                            <div class="associated-incidents-sentence-input" data-id="${value.cid}" style="display:none;"><img src="https://i.imgur.com/9Xn6xXK.png"> <input placeholder="Meses..." value="0" class="sentence-amount" data-id="${value.cid}" type="number"></div>
                        </div>`
          );
        } else {
          $(".incidents-ghost-holder").prepend(
            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                            ...
                            <div class="associated-incidents-user-tags-holder">
                                ...
                                <div class="associated-incidents-user-tag ${guiltyTag}" data-id="${value.cid}">Culpado</div>
                                <div class="associated-incidents-user-tag ${processedTag}" data-id="${value.cid}">Processado</div>
                                <div class="associated-incidents-user-tag ${associatedTag}" data-id="${value.cid}">Acossiado</div>
                            </div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}">Senteça recomendada</div>
                            ...
                            <div class="associated-incidents-fine-input" data-id="${value.cid}"><img src="https://i.imgur.com/h7S5f9J.png"> <input placeholder="Multa..." value="0" class="fine-amount" data-id="${value.cid}" type="number"></div>
                            <div class="manage-incidents-title-tag" data-id="${value.cid}">Sentença</div>
                            <div class="associated-incidents-sentence-input" data-id="${value.cid}"><img src="https://i.imgur.com/9Xn6xXK.png"> <input placeholder="Meses..." value="0" class="sentence-amount" data-id="${value.cid}" type="number"></div>
                        </div>`
          );
        }
      ...
      let table = eventData.data;
      $(".manage-bolos-editing-title").html(
        "Estas a editar o mandato " + table["id"]
      );

      if ($(".badge-logo").attr("src") == "img/ems_badge.png") {
        $(".manage-bolos-editing-title").html(
          "Estas a editar Check-in " + table["id"]
        );
      }
      ...
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${impound} impound-tag">Apreendido</div>`
      );
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${bolo}">Mandato</div>`
      );
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${codefive} code5-tag">Code 5</div>`
      );
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${stolen} stolen-tag">Roubado</div>`
      );
      $(".vehicle-info-imageurl-input").val(table["image"]);
    ...
    $(".profile-items").html(
      `
                      <div class="profile-item" data-id="0">
                          ...
                          <div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 5px; width: 100%; padding: 5px;">
                          <div style="display: flex; flex-direction: column;">
                              <div class="profile-item-title">Sem correspondecias</div>
                              </div>
                              <div class="profile-bottom-info">
                              </div>
                          </div>
