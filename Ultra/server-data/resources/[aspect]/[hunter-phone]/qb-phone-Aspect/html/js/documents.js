...
function LoadGetNotes(){
    ...
    $(".documents-select span").html("<span>Selecionar uma Nota</span>");

    var AddOption = '<div class="casino-text-clear">Sem Notas!</div>'+
...
$(document).on('click', '#documents-click-for-data', function(e){
    ...
    var AddOption = '<div class="document-body-class-body-main">'+
                        ...
                        '<textarea id="documents-textarea-new" spellcheck="false" required placeholder="Texto" maxlength="300">'+DocEndtext+'</textarea>'+
