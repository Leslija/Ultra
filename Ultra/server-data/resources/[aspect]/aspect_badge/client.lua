...
RegisterNetEvent("aspect_badge:identify")
AddEventHandler("aspect_badge:identify", function(data, coords)
...
function ShowID()
    ...
    TriggerServerEvent("aspect_badge:identify", CurrentData)
...
RegisterNetEvent("aspect_badge:editID")
AddEventHandler("aspect_badge:editID", function(data)
    EditID()
end)

RegisterNetEvent("aspect_badge:showID")
AddEventHandler("aspect_badge:showID", function()
    ShowID()
end)

RegisterNetEvent("aspect_badge:set")
AddEventHandler("aspect_badge:set", function(data)
    SetIdentification(data)
end)
