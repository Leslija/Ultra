            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Já estas numa chamada!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Pessoa esta ocupada!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Pessoa nao esta disponivel!");
            }
        } else {
