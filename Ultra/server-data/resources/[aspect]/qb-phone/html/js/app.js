    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "meos") {
                ...
                icon = '<img src="./img/apps/messages.png" class="phone-icon">';
            }else if (app.app == "settings"){
                icon = '<img src="./img/apps/settings.png" class="phone-icon">';
            }else if (app.app == "details"){
                icon = '<img src="./img/apps/info.png" class="details-icon">';
            }else if (app.app == "twitter"){
                icon = '<img src="./img/apps/twatter.png" class="twitter-icon">';
                    ...
                    $.post('https://qb-phone/GetPlayerKeys', JSON.stringify({}), function(Keys){
                        ...
                        if (Keys.length > 0) {
                            $.each(Keys, function(i, key){
                                var elem = '<div class="mykeys-key" id="keyid-'+i+'"><span class="mykeys-key-label">' + key.HouseData.adress + '</span> <span class="mykeys-key-sub">Localizar Casa</span> </div>';
