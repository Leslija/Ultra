...
Config = {
	...
	img = "s_inventory/html/images/", --Set this to the image directory of your inventory script
	Lan = "pt", -- Pick your language here
}

-- Each one has individual blip enablers
Config.Locations =  {
	['Mine'] = { name = "Mina", location = vector4(-594.96, 2091.3, 131.47-1.03, 67.65), spr = 527, col = 81, blipTrue = true }, -- The location where you enter the mine 
	...
	['Smelter'] = {	name = "Fundição", location = vector3(1112.29, -2009.9, 31.46), spr = 527, col = 81, blipTrue = true }, -- The location of the smelter
	['Cracking'] = { name = "Partir Pedra", location = vector4(1109.19, -1992.8, 30.98-1.03, 56.88), spr = 527, col = 81, blipTrue = false }, -- The location of the smelter
	['Buyer'] = { name = "Comprador Minério", location = vector4(1085.57, -2001.11, 31.4-1.03, 317.12), spr = 527, col = 81, blipTrue = false }, -- The Location of the ore buyer
	['JewelCut'] = { name = "Craft de Jóias", location = vector4(1077.11, -1984.22, 31.02-1.03, 55.8), spr = 527, col = 81, blipTrue = false }, -- The Location of the jewel cutting bench. Couldn't decide so left in smeltery
	['Buyer2'] = { name = "Comprador Jóias", location = vector4(-629.86, -240.35, 38.16-1.03, 110.05), spr = 527, col = 81, blipTrue = false }, -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
}
...
--Mining Store Items
Config.Items = {
    label = "Loja Mineiros",  slots = 7,
    items = {
	[1] = { name = "water_bottle", price = 0, amount = 100, info = {}, type = "item", slot = 1, },
	[2] = { name = "sandesmista", price = 0, amount = 250, info = {}, type = "item", slot = 2, },
