...
QBCore.Functions.CreateCallback('s_mineiros:Check', function(source, cb, item, tablenumber, table)
	local hasitem = false
...
RegisterServerEvent('s_mineiros:GetItem', function(data)
	local src = source
	...
	TriggerClientEvent("s_mineiros:CraftMenu", src, data)
end)

RegisterServerEvent('s_mineiros:MineReward', function()
...
RegisterServerEvent('s_mineiros:CrackReward', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("s_mineiros:Selling", function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent("s_mineiros:SellJewel", function(data)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local currentitem = data
    if Player.Functions.GetItemByName(data) ~= nil then
...
QBCore.Functions.CreateCallback('s_mineiros:Cutting:Check:Tools', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
