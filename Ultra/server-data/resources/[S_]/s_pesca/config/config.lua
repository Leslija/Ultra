...
Config.targetExport = "s_target"                               -- The name of the Target export you are using ["s_target", "qtarget", "bt-target"]

Config.PearlsSellsBlip = vector3(651.19, -47.1, 4.82)  -- Blip to sell fish you have caught
...
-- Regular Fish
Config.mackerelPrice     = 3                                    -- Price of Mackerel
Config.codfishPrice      = 5                                   -- Price of Cod
Config.bassPrice         = 10                                   -- Price of Normal Fish
Config.flounderPrice     = 15                                   -- Price of Flounder
Config.stingrayPrice     = 20                                   -- Price of Stingrays

-- Exotic Fish
Config.dolphinPrice      = 35                                 -- Price of Dolphins
Config.sharktigerPrice   = 35                                  -- Price of Tigersharks
Config.sharkhammerPrice  = 40                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = 52                                  -- Price of Killer whales
...
Config.largeLootboxRewards = {                                  -- Rewards found in the treasure chest (keep price = 0)
    [1] = { name = "sandesmista", price = 0, amount = 5, info = {}, type = "item", slot = 1, },
	[2] = { name = "cocaleaf", price = 0, amount = 5, info = {}, type = "item", slot = 2, },
    [3] = { name = "diamond_ring", price = 0, amount = 1, info = {}, type = "item", slot = 3, },
    [4] = { name = "ruby_ring", price = 0, amount = 1, info = {}, type = "item", slot = 4, },
    [5] = { name = "uncut_diamond", price = 0, amount = 1, info = {}, type = "item", slot = 5, },

}


Config.PedList = {                                              -- Peds that will be spawned in (if you change a ped model here you need to also change the ped model in client/addons.lua s_target exports)
	{
