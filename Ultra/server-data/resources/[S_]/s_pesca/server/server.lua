...
QBCore.Functions.CreateUseableItem("fishingloot", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		TriggerClientEvent('QBCore:Notify', src, "A abrir caixa", "primary")
		SetTimeout(1000, function()
			...
			TriggerClientEvent('QBCore:Notify', src, "Encontras-te algumas coisas e "..Config.smallLootboxCash.."€", "success")
		end)
    end
end)
...
QBCore.Functions.CreateUseableItem("fishtacklebox", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		TriggerClientEvent('QBCore:Notify', src, "A abrir caixa de equipamentos", "success")
...
RegisterNetEvent("fishing:server:addTackleBox", function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	TriggerClientEvent('QBCore:Notify', src, "Parece uma caixa de equipamentos deixada por outro pescador", "primary")
	SetTimeout(1000, function()
...
RegisterNetEvent("fishing:server:returnDeposit", function()
	...
	TriggerClientEvent('QBCore:Notify', src, "O barco foi devolvido por "..price.."€", "success")
end) 
    ...
    if itemFound then
        for i = 1, itemCount, 1 do
            if luck == 100 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Você capturou uma baleia assassina!\nEstas são espécies ameaçadas de extinção e sua posse é ilegal", "primary")
			elseif luck >= 95 and luck <= 100 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Encontras-te um báu de tesouro!", "success")
			elseif luck >= 90 and luck <= 95 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Apanhas-te um golfinho!\nEstas são espécies ameaçadas de extinção e sua posse é ilegal", "primary")
			elseif luck >= 85 and luck <= 90 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Apanhas-te um tubarão martelo!\nEstas são espécies ameaçadas de extinção e sua posse é ilegal", "primary")
			elseif luck >= 80 and luck <= 85 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Apanhas-te um tubarão tigre!\nEstas são espécies ameaçadas de extinção e sua posse é ilegal", "primary")
			elseif luck >= 75 and luck <= 80 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Tu apanhas-te um "..weight.."lbs Arraia!", "success")
			elseif luck >= 70 and luck <= 75 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Tu apanhas-te um " .. weight .. "lbs Peixe Linguado", "success")
			elseif luck >= 65 and luck <= 70 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Apanhas-te uma bota de pesca!", "primary")
			elseif luck >= 60 and luck <= 65 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Tu apanhas-te um " .. weight .. "lbs Robalo", "success")
			elseif luck >= 55 and luck <= 60 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Encontras-te uma caixa pequena!", "success")
			elseif luck >= 50 and luck <= 55 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Tu apanhas-te um " .. weight .. "lbs  Bacalhau", "success")
			elseif luck >= 45 and luck <= 50 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Apanhas-te uma lata de pesca!", "primary")
			elseif luck >= 0 and luck <= 45 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Tu apanhas-te um " .. weight .. "lbs Peixe Cavalinha", "success")
            end
            Citizen.Wait(500)
        end
    end
...
RegisterNetEvent('fishing:server:SellillegalFish', function(args)
	...
	if args == 1 then 
		...
		if dolphin ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Golfinho vendido por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Não tens nenhum golfinho para vender", 'error')
		end
	elseif args == 2 then 
		...
		if sharktiger ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Tubarão Tigre vendido por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Não tens nenhum Tubarão Tigre para vender", 'error')
		end
	elseif args == 3 then 
		...
		if sharkhammer ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Tubarão Martelo vendido por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Não tens nenhum tubarão martelo para vender", 'error')
		end
	else
		...
		if killerwhale ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Baleia Assasina vendida por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Não tens nenhuma baleia assasina para vender.", "error")
		end
	end
end)
...
RegisterNetEvent('fishing:server:SellLegalFish', function(args) 
	...
	if args == 1 then 
		...
		if mackerel ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Peixe Cavalinha vendido por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Não tens nenhum peixe cavalinha para vender.", "error")
		end
	elseif args == 2 then
		...
		if codfish ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Bacalhau vendido por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Não tens nenhum bacalhau para vender", "error")
		end
	elseif args == 3 then
		...
		if bass ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Robalo vendido por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Não tens nenhum robalo para vender", "error")
		end
	elseif args == 4 then
		...
		if flounder ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Peixe Linguado vendido por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Não tens nenhum peixe linguado para vender", "error")
		end
	else
		...
		if stingray ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Arraia vendida por "..payment.."€", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Não tens nenhuma arraia para vender", "error")
		end
	end
end)
...
QBCore.Functions.CreateCallback('fishing:server:checkMoney', function(source, cb)
    ...
    if bankBalance >= price then
		...
		TriggerClientEvent('QBCore:Notify', src, "Barco foi alugado por "..price.."€", "success")
        cb(true)
    else
        TriggerClientEvent('QBCore:Notify', src, "Não tens dinheiro suficiente..", "error")
        cb(false)
