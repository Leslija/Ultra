...
Config.canCost = 150 -- buy jerry can price
...
Config.GasStationsBlips = { -- gas station blips
    vector3(-241.08, 282.45, 7.74),
    vector3(-1153.41, 524.67, 6.96),
    vector3(1369.23, 134.8, 19.06),
    vector3(1009.81, 688.61, 6.02),
    vector3(1361.87, 820.99, 29.82),
    vector3(2010.06, 1332.42, 16.43),
    vector3(1691.68, 2204.85, 16.69),
    vector3(-196.53, 473.61, 9.86),
    vector3(-1074.57, 2229.16, 27.92)
}
