local webhook <const> = "https://discord.com/api/webhooks/938931477486391447/YpAOcAkJ9H3W-G2o9ibvHSqKxjnTMzcscCWvFdKyrWdCLvIdIKqZLZxQra5QvphsOxi9" -- do not share your webhook with others
...
function sendWebhook(name, identifier, type, value, amount, early)
  ...
  local winMessage <const> = {
    ...
    ["embeds"] = {
      {
        ["description"] = (type == "item" and ("**" .. name .. "** ganhou " .. amount .. "x " .. value .. " ao usar uma raspadinha!") or ("**" .. name .. "** ganhou " .. value .. "€ ao usar uma raspadinha!")),
        ["fields"] = {
          {
            ["name"] = "Identifier",
            ["value"] = identifier
  ...
  local loseMessage <const> = {
    ...
    ["embeds"] = {
      {
        ["description"] = "**" .. name .."** perdeu ao usar uma raspadinha.",
        ["fields"] = {
          {
            ["name"] = "Identifier",
            ["value"] = identifier
  ...
  local earlyMessage <const> = {
    ["embeds"] = {
      {
        ["description"] = "**" .. name .. "** fechou mais cedo antes de raspar a raspadinha toda. (**" .. name .. "** " .. amount .. "x " .. value .. ")",
        ["fields"] = {
          {
            ["name"] = "Identifier",
            ["value"] = identifier
