			...
			n = (s("d3b7"), {
				...
				methods: {
					...
					scrollToClass: function (t) {
						...
						void 0 != e && "undefined" != e && e.scrollIntoView()
					},
					Pressed_Key: function (t) {
						...
						}), this.text_button_remove_tattoos = this.Texts_Nui.ButtonTattooRemoved, this.text_button_remove_tattoos_style = "border: 0.2vh solid rgba(0, 255, 0, 0.3); color: green;", setTimeout(function () {
						...
						}.bind(this), 2500))), this.selected >= 0 && this.scrollToClass(this.list[this.selected].title + this.list[this.selected].dlc)
					}
				},
				created: function () {
...
//# sourceMappingURL=app.81b69995.js.map