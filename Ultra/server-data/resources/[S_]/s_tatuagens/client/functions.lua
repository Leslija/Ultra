...
function CreateIcons()
	for i, k in pairs(tattoosShops) do
		...
		SetBlipColour(BlipMap, 75)
		SetBlipScale(BlipMap, 0.5)
		SetBlipAsShortRange(BlipMap, true)
		AddTextEntry("BlipMap", "Malditos Diamantes Tattoo")
...
function RegisterTattoos()
    TriggerServerEvent("qs-tattoos:RegisterTattoos", update_tattoos, tattoos_price, freetattoos)
    update_tattoos = {}
