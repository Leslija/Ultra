...
cfg = {
    ...
    commandSuggestion = 'Abrir painel de animações', -- Open the animations panel suggestion
    commandNameEmote = 'e', -- Play an animation by command
    commandNameSuggestion = 'Faz uma animação por comando', -- Play an animation by command suggestion
    keyActive = false, -- Use key for opening the panel
    keyLetter = 'F3', -- Which key for opening the panel if cfg.keyActive is true
    keySuggestion = 'Abrir painel de animações', -- Suggestion on keybind mapping
