...
QBCore.Commands.Add('job', 'Vê o teu trabalho', {}, false, function(source)
...
QBCore.Commands.Add('org', 'Ver a tua organização', {}, false, function(source)
...
QBCore.Commands.Add('setorg', 'Colocar player em uma org (Admin Only)', { { name = 'id', help = 'Player ID' }, { name = 'gang', help = 'Nome ORG' }, { name = 'grade', help = 'Grade' } }, true, function(source, args)
    local Player = QBCore.Functions.GetPlayer(tonumber(args[1]))
    if Player then
