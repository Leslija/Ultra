...
window.addEventListener("message", function (event) {
  ...
  if (data.talking == 1) {
    VoiceIndicator.path.setAttribute("stroke", "cyan");
  ...
  if (data.hp < 0) {
    ...
    HealthIndicator.trail.setAttribute("stroke", "gray");
  ...
  if (data.rpm > 0) {
    ...
    if (data.rpm > 95) {
      ...
      Speedometer.path.setAttribute("stroke", "cyan");
    } else if (data.rpm == 0) {
